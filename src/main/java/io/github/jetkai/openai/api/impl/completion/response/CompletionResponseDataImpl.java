...
public class CompletionResponseDataImpl extends CompletionResponseData {
    ...
    private CompletionResponseDataImpl(CompletionResponseDataBuilderImpl builder) {
        this.id = builder.id;
    ...
    public static CompletionResponseDataImpl create(CompletionResponseDataBuilderImpl builder) {
        return new CompletionResponseDataImpl(builder);
    }
