 ...
 * {@code - 02/03/2023}
 */
public class CompletionChoiceDataImpl extends CompletionChoiceData {
    ...
    static CompletionChoiceDataImpl create(CompletionChoiceDataBuilderImpl builder) {
        return new CompletionChoiceDataImpl(builder);
    }

    private CompletionChoiceDataImpl(CompletionChoiceDataBuilderImpl builder) {
