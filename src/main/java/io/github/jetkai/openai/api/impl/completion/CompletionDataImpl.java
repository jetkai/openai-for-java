 ...
 * {@code - 05/03/2023}
 */
public class CompletionDataImpl extends CompletionData {
    ...
    static CompletionDataImpl create(CompletionBuilderImpl builder) {
        return new CompletionDataImpl(builder);
    }

    private CompletionDataImpl(CompletionBuilderImpl builder) {
